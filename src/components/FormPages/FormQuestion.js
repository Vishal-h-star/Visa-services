              ...
              <div className="info-row">
                <span className="label">
                  ...
                  <strong className="text-uppercase">
                    {securityAnswers?.applicationType}
                  </strong>
                </span>
              ...
              <div className="form-fields-single-column ">
                {form_questions.map((question) => (
                  <>
                    <div
                      key={question.key}
                      className="form-field-horizontal questionsForm"
                    >
                ...
                <div className="undertaking-content question_declear">
                  <label>
                    ...
                    <b style={{ textTransform: "uppercase" }}>
                      {securityAnswers?.surname}
                    </b>
                    &nbsp; , hereby declare that the information furnished above
                    is correct to the best of my knowledge and belief. In case
                    the information is found false at any stage, I am liable for
                    legal action/deportation/blacklisting or any other action as
